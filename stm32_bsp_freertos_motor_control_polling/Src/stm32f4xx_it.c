...
extern TIM_HandleTypeDef hTimPwm1A;
/// Timer handler for PWM of Input 2 Bridge A
extern TIM_HandleTypeDef hTimPwm2A;
/// Timer handler for PWM of Input 1 Bridge B
extern TIM_HandleTypeDef hTimPwm1B;
/// Timer handler for PWM of Input 2 Bridge B
extern TIM_HandleTypeDef hTimPwm2B;
